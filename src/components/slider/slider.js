            ...
            <div className="infocontainer">
              ...
              {item.id === 1 && (
                <div className="infocontainer-cover" >
                  <button className="infocontainer-button"> <a href="#home-page-buy">КУПИТЬ</a> </button>
                  <button className="infocontainer-button"> <a href="#home-page-rent">АРЕНДОВАТЬ</a>  </button>
                </div>
              )}
            </div>
          </div>
