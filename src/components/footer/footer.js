...
// import certificate '../image/certificate'
    ...
    return (<div className="footer-container">
        <ul>
            ...
            <div className="certificate-container">
                <div className="certificate-title">В ADJARA PEAK можно преобрести сертификат на любую сумму</div>
            <img className="image" src={certificate} alt='certificate' width={350}/>
            </div>
