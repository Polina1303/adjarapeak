...
export const PRODUCT = [
      ...
      },
    {
        ...
        category: "sleeping bag",
        price: 125,
        column: ["Вес: 1060гр","Размер внешний: 40*25см","Материал: полиэстерн, СИНТЕПОН"],
      },
    {
      id: uuid(),
    ...
    },
    {
      ...
      category: "accessories",
      price: 182,
      shortly:'Компактный и легкий бинокль с простой регулировкой. Идеален для обзора панорамы во время походов. Большие объективы (32 мм) и специальное покрытие оптики для обеспечения четкости изображения. Подходит для тех, кто носит очки, благодаря выдвижному глазку, который можно откинуть назад.',
      column: ["Вес: 333г",
