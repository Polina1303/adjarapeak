...
const PRODUCT = [
  ...
  },
  {
    ...
    column: [
      ...
      "Количество входов:2",
      "Комплектация:Колышки, оттяжки, инструкция",
      "Размер в упаковке (см):57х17х14,5",
      "Высота (см):120",
  ...
  },
  {
    ...
    column: [
      ...
      "Количество входов:2",
      "Комплектация:Колышки, оттяжки, инструкция",
      "Размер в упаковке (см):57х17,5х15,5",
      "Высота (см):120",
      "Наружний габарит (см):300*210",
      "Тамбур (см):1х100, 1х50",
      "Упаковка:Тканевая сумка",
    ],
  },
  {
  ...
  },
  {
    ...
    column: ["Вес:1.8кг", "Материал:Нейлон"],
  },
  {
    id: 15,
    title: "РЮКЗАК ТУРИСТИЧЕСКИЙ",
  ...
  },
  {
    ...
    category: "accessories",
    price: 22,
    column: ["Размер в сложенном виде: 47*33см"],
  },
];
...
const RENT = [
  {
    ...
    column: [
      ...
      "Материал внутренней палатки:нет",
      "Вес (г):1800",
      "Количество слоев:1",
      "Количество мест:2",
      "Количество входов:1",
  ...
  },
  {
    ...
    day: "будни",
    price: 3,
    column: ["Материал купола:Нейлон", "Регулировка высоты:	Есть", "Вес:600гр"],
  },
  {
    id: 73,
    title: "ЗОНТ ПЛЯЖНЫЙ (СКЛАДНОЙ)",
