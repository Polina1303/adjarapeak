...
const getEmptyMessage = () => {
  if (filter === "individual") {
    return "На данный момент индивидуальных туров нет. Но вы всегда можете заказать тур в любой день по запросу!";
  }
  if (filter === "group") {
    return "Ближайших групповых туров пока нет. Следите за анонсами!";
  }
  if (filter === "rockClimbing") {
    return "Скалолазание временно приостановлено. Скоро вернёмся!";
  }
