        ...
        <Paper elevation={3} sx={{ p: 4, borderRadius: 4 }}>
          ...
          <Stack spacing={3}>
            <Box display="flex" alignItems="flex-start" gap={2}>
              ...
              <Box>
                <Typography variant="h6" sx={{ fontFamily: "RoadRadio-Bold" }}>
            ...
            <Box display="flex" alignItems="flex-start" gap={2}>
              <Typography
                variant="h6"
                sx={{ mr: 2, fontFamily: "RoadRadio-Bold" }}
              >
                {languages === "RU"
                  ? "Соцсети Adjara Peak:"
                  : "Follow Adjara Peak:"}
          ...
          <Typography
            variant="h6"
            sx={{ mt: 0.3, fontFamily: "RoadRadio-Thin" }}
          >
            {languages === "RU" ? "Местоположение" : "Location"}
          </Typography>
          <Paper
            elevation={3}
            sx={{ mt: 0.3, borderRadius: 4, overflow: "hidden" }}
          >
            <Box sx={{ width: "100%", height: "400px" }}>
              <iframe
                title="Adjara Peak Location"
                src="https://maps.google.com/maps?width=100%25&amp;height=400&amp;hl=en&amp;q=41.63342805662303,%2041.61548271005293+(Adjara%20Peak)&amp;t=&amp;z=16&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                width="100%"
                height="100%"
                frameBorder="0"
