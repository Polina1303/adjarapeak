...
export const ProductPage = () => {
  ...
  useEffect(() => {
    ...
    if (product && product.id === Number(params.id)) {
      console.log("Product already loaded, skipping");
      return;
    }
  ...
  }, [dispatch, params.id, product, redirectToError]);
        ...
        <Box className="product-top">
          ...
          <Box className="product-info">
            <Typography
              ...
              sx={{ fontFamily: "RoadRadio, sans-serif" }}
            >
              {product.title}
            </Typography>
