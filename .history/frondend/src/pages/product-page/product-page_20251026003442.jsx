  ...
  return (
    <>
      ...
      <Card className="product-card">
        {/* Верхняя строка: изображение + инфо */}
        ...
        <Box className="product-description">
          ...
          <Box className="product-desc-text">
            {product.desc && <Typography>{product.desc}</Typography>}
            {product.shortly && <Typography>{product.shortly}</Typography>}

            {product.day && (
              <Typography variant="h6" className="product-day">
                {product.day}
              </Typography>
            )}
