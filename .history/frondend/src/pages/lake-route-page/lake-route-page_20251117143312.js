    ...
    <>
      ...
      <div className={styles["lake-route-page-cover"]}>
        <div ref={ref} className={styles["lake-route-page-cover-img"]}>
          <div>
            <img src={lake1} alt="lake" className={styles["route-page-img"]} />
          </div>
          <div>
            <img src={lake2} alt="lake" className={styles["route-page-img"]} />
          </div>
          <div>
            <img src={lake3} alt="lake" className={styles["route-page-img"]} />
          </div>
          <div>
