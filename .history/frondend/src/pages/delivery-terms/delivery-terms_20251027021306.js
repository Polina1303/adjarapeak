      ...
      >
        ...
        <Stack spacing={3}>
          <Box>
            <Typography
              variant="h6"
              sx={{ fontFamily: "RoadRadio", fontWeight: 600 }}
            >
              Для заказа до 300 лари по Батуми
            </Typography>
            <Typography variant="body1" sx={{ fontFamily: "RoadRadio-Thin" }}>
          ...
          <Box>
            ...
            <Typography
              variant="body1"
              sx={{ color: "green", fontFamily: "RoadRadio-Thin" }}
            >
              Доставка: бесплатно
            </Typography>
          </Box>
          ...
          <Typography variant="body2" sx={{ mt: 1, fontFamily: "RoadRadio" }}>
            ...
            <Link
              ...
              sx={{
                color: "#bf561f",
                textDecoration: "underline #bf561f",
                marginLeft: "4px", // добавляем отступ
              }}
            >
              WhatsApp
            </Link>
