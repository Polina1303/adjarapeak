...
// import { RockClimbing } from "../../components/rock-climbing";
...
export const HomePage = () => {
  ...
  // предотвращает несоответствие SSR / CSR
  useEffect(() => {
    setHydrated(true);
  }, []);
  ...
  if (!hydrated) return null; // предотвращает гидратационную ошибку
          ...
          <Link href="/rent-sky" className={styles.saleCard}>
            ...
            <div className={styles.saleInfo}>
              <div className={styles.saleTitle}>
                ...
                <br />
                {isRU ? "горнолыжного снаряжения" : "of ski equipment"}
              </div>
            </div>
          </Link>
        </article>
