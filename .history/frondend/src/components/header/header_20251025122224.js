        ...
        >
          ...
          <Box
            sx={{
              ...
              "@media (max-width:1200px)": {
                display: "none", // скрываем меню при <=1200px
              },
              "@media (min-width:1201px) and (max-width:1400px)": {
                gap: "70px", // уменьшаем отступы между пунктами
              },
              "@media (min-width:1401px) and (max-width:1600px)": {
                gap: "90px", // немного увеличиваем при больших экранах
              },
              "@media (min-width:1601px)": {
                gap: "110px", // по умолчанию для очень больших экранов
              },
              "@media (max-width:1200px)": {
                display: "none",
              },
