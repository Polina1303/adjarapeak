    ...
    <>
      <Box
        sx={{
          backgroundColor: "#000",
          color: "#fff",
          padding: { xs: "2px 8px", sm: "3px 9px", md: "4px 10px" },
          ...
          whiteSpace: "nowrap",
          textAlign: "center",
          transition: "all 0.3s ease !important", // Добавляем important
        }}
      >
        <Typography
          variant="body2"
          sx={{
            ...
            fontSize: "inherit !important", // Наследуем размер от родителя
          }}
        >
          {deliveryText}
        </Typography>
