    ...
    <>
      ...
      <div className="header">
        ...
        <div className="location">
          ...
          <Link to="/">{languages === "RU" ? "МАГАЗИН" : "SHOP"}</Link>
          <Link to="/">{languages === "RU" ? "ПРОКАТ" : "Shop"}</Link>
          <Link to="/">{languages === "RU" ? "ТУРЫ" : "Shop"}</Link>
          <Link to="/">{languages === "RU" ? "СКАЛОЛАЗАНИЕ" : "Shop"}</Link>
          <Link to="/">{languages === "RU" ? "СЕРВИС-ЦЕНТР" : "Shop"}</Link>
          <Link to="/">{languages === "RU" ? "КОНТАКТЫ" : "Shop"}</Link>
        </div>
