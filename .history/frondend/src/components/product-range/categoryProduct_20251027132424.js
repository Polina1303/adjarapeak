export const CATEGORY_PRODUCT = [
  { title: "ТУРИЗМ И КЕМПИНГ", type: "camping" },
  { title: "ИГРОВОЙ СПОРТ", type: "gamesport" },
  { title: "ФИТНЕС И ЙОГА", type: "fitness" },
  { title: "ЕДИНОБОРСТВА", type: "martialart" },
  { title: "ВЕЛОСПОРТ И РОЛИКИ", type: "bikerollers" },
  {
    title: "ПЛАВАНИЕ И САПЫ",
    type: ["supboard", "sup_accessories", "hat_sea", "flippers", "mask"],
  },
  { title: "ОДЕЖДА И ОБУВЬ", types: ["clothes", "shoes", "shoesSea"] },
  { title: "ГОРНОЛЫЖНЫЙ СПОРТ", type: "skiing" },
  { title: "ЕДА", type: "food" },
  // {
  //   title: "ВСЁ",
  //   // type:'all',
