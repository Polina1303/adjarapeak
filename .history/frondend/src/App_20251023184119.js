...
import { ServiceCenter } from "./pages/service-center-page/service-center-page";
    ...
    <>
      <div className="App">
        ...
        <Routes>
          ...
          <Route exact path="/service" element={<ServiceCenter />} />
          ...
          <Route exact path="/rental" element={<RentalPage />} />
