...
import { SaleCategoryPage } from "../pages/tourism-camping-page";
        ...
        children: [
          {
            index: true,
            Component: () => (
              <SaleCategoryPage category={CATEGORY_PRODUCT[0]} />
            ),
          },
          ...CATEGORY_PRODUCT.map((section) => ({
            path: section.path,
            Component: () => <SaleCategoryPage category={section} />,
            children: section.types
              ? section.types.map((type) => ({
                  path: type.category,
                  Component: () => <SaleCategoryPage category={type} />,
                  children: type.subcategories
                    ? type.subcategories.map((sub) => ({
                        path: sub.subcategory,
                        Component: () => <SaleCategoryPage category={sub} />,
                      }))
                    : [],
                }))
              : [],
