...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      // },
      {
        ...
        Component: SalePage,
        children: [
          // Главная страница sale — показываем карточки всех разделов
          {
            index: true,
            Component: () => <TourismCampingPage category={CATEGORY_PRODUCT} />,
          },
          // Динамические маршруты для каждого раздела
