import {
  ...
  F as A,
  I as X,
} from "./index-C3gPC8Qd.js";
import { B } from "./button-CzSAyR0u.js";
import { C as z, T as te, a as re, P as se } from "./textarea-Bhzp_Jgs.js";
import { I as k } from "./input-CtgoE4v5.js";
import { L as C } from "./label-DinQmSN_.js";
import { g as G } from "./gift-card-cart-DRnCOMEC.js";
import { A as ae } from "./arrow-left-DpLz3Kml.js";
import { C as oe } from "./chevron-down-Dxb1tmDt.js";
import "./index-Nqz3pKCv.js";
import "./utils-DclmTqRz.js";
import "./index-DEAcRPbk.js";
import "./index-42ZYkH7a.js";
import "./check-CA8kapgV.js";
const ne = [["path", { d: "M21 12a9 9 0 1 1-6.219-8.56", key: "13zald" }]],
  le = U("loader-circle", ne);
const de = [["path", { d: "M5 12h14", key: "1ays0h" }]],
  ce = U("minus", de),
  ie = "https://adjarapeak-api-production.up.railway.app/api/order";
function me() {
  return ie;
}
const ue = {
  RU: {
    ...
    decrease: "Уменьшить",
    increase: "Увеличить",
    giftCardTitle: (t) => `Подарочная карта на ₾${t}`,
    itemCount: (t) => `${t} ${pe(t)}`,
    groupCount: (t) => `${t} шт.`,
    staleOne: "Один товар из корзины больше недоступен и был удалён",
    staleMany: (t) =>
      `${t} товаров из корзины больше недоступны и были удалены`,
  ...
  EN: {
    ...
    purchase: "Purchase",
    rental: "Rental",
    summaryItems: (t) => `${t} ${t === 1 ? "item" : "items"}`,
    total: "Total",
    ...
    decrease: "Decrease",
    increase: "Increase",
    giftCardTitle: (t) => `Gift card for ₾${t}`,
    itemCount: (t) => `${t} ${t === 1 ? "item" : "items"}`,
    groupCount: (t) => `${t} ${t === 1 ? "item" : "items"}`,
    staleOne: "One item in your cart is no longer available and was removed",
    staleMany: (t) =>
      `${t} items in your cart are no longer available and were removed`,
  ...
  GE: {
    ...
    decrease: "შემცირება",
    increase: "გაზრდა",
    giftCardTitle: (t) => `სასაჩუქრე ბარათი ₾${t}`,
    itemCount: (t) => `${t} ნივთი`,
    groupCount: (t) => `${t} ნივთი`,
    staleOne: "კალათაში ერთი ნივთი აღარ არის ხელმისაწვდომი და წაიშალა",
    staleMany: (t) => `კალათაში ${t} ნივთი აღარ არის ხელმისაწვდომი და წაიშალა`,
...
function Le() {
  const t = Q(),
    ...
    [v, f] = h.useState(!1),
    [g, p] = h.useState({}),
    [b, y] = h.useState({ shop: !0, rental: !0 }),
    [n, c] = h.useState({
      name: "",
      phone: "",
      telegram: "",
    ...
    [E, T] = h.useState(!1),
    F = t.map((r) => r.slug).join(",");
  (h.useEffect(() => {
    if (t.length === 0) return;
    const r = t.filter((s) => !u[s.slug]).map((s) => s.slug);
    r.length !== 0 &&
      (f(!0),
      Z({ data: { slugs: r } })
        .then((s) => {
          w((i) => {
            const q = { ...i };
            for (const _ of s) q[_.slug] = _;
            return q;
          });
          const o = new Set(s.map((i) => i.slug)),
            l = t.filter(
              (i) => r.includes(i.slug) && !o.has(i.slug) && !i.title
            );
          if (l.length > 0) {
            for (const i of l) $(i.slug);
            x.info(l.length === 1 ? a.staleOne : a.staleMany(l.length));
          }
        })
        .finally(() => f(!1)));
  }, [F, a]),
    h.useEffect(() => {
      p((r) => {
        const s = { ...r };
        let o = !1;
        for (const l of t) l.slug in s || ((s[l.slug] = !0), (o = !0));
        for (const l of Object.keys(s))
          t.find((i) => i.slug === l) || (delete s[l], (o = !0));
        return o ? s : r;
      });
    }, [F]));
  const W = t.length > 0 && t.every((r) => g[r.slug]),
    N = t.filter((r) => g[r.slug]),
    O = N.reduce((r, s) => r + s.qty, 0);
  function j(r) {
    const s = u[r.slug];
    if (s) return s;
    const o = r.slug.match(/^giftcard-(\d+)$/)?.[1];
    if (o)
      return {
        slug: r.slug,
        kind: "shop",
        title: r.title ?? a.giftCardTitle(Number(o)),
        image: G,
        price: r.price ?? Number(o),
        unit: "",
        available: !0,
        description: null,
      };
  ...
  const S = N.reduce((r, s) => {
      const o = j(s);
      return o ? r + o.price * s.qty : r;
    }, 0),
    L = N.some((r) => j(r)?.kind === "rental"),
    R = t.filter((r) => j(r)?.kind === "rental"),
    I = t.filter((r) => {
      const s = j(r);
      return !s || s.kind !== "rental";
    });
  function J(r) {
    const s = {};
    for (const o of t) s[o.slug] = r;
    p(s);
  }
  function K() {
    const r = t.filter((s) => g[s.slug]);
    if (r.length !== 0) {
      for (const s of r) $(s.slug);
      x.success(a.selectedRemoved);
    }
  }
  async function H(r) {
    if ((r.preventDefault(), N.length === 0)) {
      x.error(a.selectOneError);
      return;
    }
    if (!n.name.trim()) return x.error(a.nameError);
    if (!n.phone.trim()) return x.error(a.phoneError);
    if (L && (!n.dateFrom || !n.dateTo)) return x.error(a.rentalDatesError);
    const s = N.map((o) => {
      const l = j(o);
      return l
        ? {
    ...
    if (s.length === 0) {
      x.error(a.prepareError);
      return;
    }
    T(!0);
    try {
      const o = await fetch(me(), {
          method: "POST",
          ...
          body: JSON.stringify({
            ...
            rental: { dateStart: n.dateFrom, dateEnd: n.dateTo },
            comments: n.comment.trim(),
            items: s,
            summary: { totalItems: O, total: S },
          }),
        }),
        l = await o.json().catch(() => null);
      if (!o.ok) throw new Error(l?.msg || l?.error || a.sendError);
      for (const i of N) $(i.slug);
      (c({
        name: "",
        phone: "",
        telegram: "",
      ...
      x.error(o instanceof Error ? o.message : a.sendError);
    } finally {
      T(!1);
    }
  }
        ...
        children: e.jsxs("div", {
          ...
          children: [
            ...
            e.jsx("h1", {
              ...
              children: a.emptyTitle,
            }),
            e.jsx("p", {
              className: "font-body text-muted-foreground mb-6",
              children: a.emptyText,
            }),
            e.jsx(B, {
              asChild: !0,
              className: "bg-ember text-ember-foreground hover:bg-ember/90",
              children: e.jsx(P, { to: "/sale", children: a.goShopping }),
            }),
          ],
        }),
      })
          ...
          children: e.jsxs("div", {
            ...
            children: [
              e.jsxs("button", {
                ...
                children: [e.jsx(ae, { className: "h-4 w-4" }), a.back],
              }),
              e.jsx("div", {
                          ...
                          I.length > 0 &&
                            e.jsx(M, {
                              ...
                              setExpanded: (r) =>
                                y((s) => ({
                                  ...s,
                                  shop: typeof r == "function" ? r(s.shop) : r,
                                })),
                            }),
                          R.length > 0 &&
                            e.jsx(M, {
                              ...
                              setExpanded: (r) =>
                                y((s) => ({
                                  ...s,
                                  rental:
                                    typeof r == "function" ? r(s.rental) : r,
                                })),
                            }),
                        ],
                      }),
                      ...
                      e.jsxs("div", {
                        ...
                        children: [
                          e.jsxs("div", {
                            ...
                            children: [
                              e.jsx("span", { children: a.summaryItems(O) }),
                      ...
                      e.jsxs("form", {
                        ...
                        children: [
                                  ...
                                  children: [
                                    e.jsx(k, {
                                      ...
                                      onChange: (r) =>
                                        c((s) => ({
                                          ...s,
                                          dateFrom: r.target.value,
                                        })),
                                      required: L,
                                      className: `text-xs md:text-sm ${n.dateFrom ? "text-foreground" : "text-muted-foreground/40"}`,
                                    }),
                                    e.jsx(k, {
                                      type: "date",
                                      value: n.dateTo,
                                      onChange: (r) =>
                                        c((s) => ({
                                          ...s,
                                          dateTo: r.target.value,
                                        })),
                                      required: L,
                                      min: n.dateFrom || void 0,
                                      className: `text-xs md:text-sm ${n.dateTo ? "text-foreground" : "text-muted-foreground/40"}`,
                                    }),
                                  ],
                                }),
                              ],
                          ...
                          e.jsxs("div", {
                            ...
                            children: [
                              e.jsx(C, {
                                ...
                                className:
                                  "font-display text-xs uppercase tracking-wider",
                                children: a.commentLabel,
                              }),
                              e.jsx(te, {
                                id: "co-comment",
                                value: n.comment,
                                onChange: (r) =>
                                  c((s) => ({ ...s, comment: r.target.value })),
                          ...
                          e.jsx(B, {
                            ...
                            children: E ? a.submitting : a.submit,
                          }),
                        ],
                      }),
                    ],
...
function M({
  ...
  const b = m === "moss" ? "bg-moss/10" : "bg-ember/10",
    y = m === "moss" ? "text-moss" : "text-ember",
    n = m === "moss" ? "border-moss/30" : "border-ember/30";
  return e.jsxs("div", {
    className: `rounded-xl bg-background border ${n} overflow-hidden`,
    children: [
      e.jsxs("button", {
        type: "button",
        onClick: () => p((c) => !c),
        className: `w-full flex items-center justify-between px-4 md:px-5 py-3 md:py-4 ${b} hover:opacity-90 transition-opacity`,
        children: [
          e.jsxs("span", {
            className: "flex items-center gap-3",
            children: [
              e.jsx("span", {
                className: `font-display text-[10px] md:text-xs font-bold uppercase tracking-wider px-2 py-0.5 rounded ${y} bg-background/70 border ${n}`,
                children: t,
              }),
              e.jsx("span", {
                className:
                  "font-display text-sm md:text-base font-semibold uppercase tracking-wider text-foreground",
                children: d.groupCount(a.length),
              }),
            ],
          }),
          g
            ? e.jsx(re, { className: "h-5 w-5 text-muted-foreground" })
            : e.jsx(oe, { className: "h-5 w-5 text-muted-foreground" }),
        ],
      }),
      g &&
        e.jsx("ul", {
...
function ge({
  ...
  const v = t.slug.startsWith("giftcard-") ? G : A(d?.image ?? t.slug),
    f = "/app/$slug",
    g = d ? d.price * t.qty : 0;
  return e.jsx("li", {
            ...
            e.jsxs("div", {
              ...
              children: [
                e.jsx(P, {
                  ...
                  children: d?.title ?? (m ? u.loading : t.slug),
                }),
                d?.description &&
                  e.jsx("div", {
                    className:
            ...
            e.jsxs("div", {
              ...
              children: [
                e.jsx("button", {
                  ...
                  "aria-label": u.decrease,
                  children: e.jsx(ce, { className: "h-3.5 w-3.5" }),
                }),
                e.jsx("div", {
                  className:
                ...
                e.jsx("button", {
                  ...
                  className:
                    "h-9 w-9 rounded-md border border-border flex items-center justify-center text-muted-foreground hover:text-ember hover:border-ember transition-colors",
                  "aria-label": u.increase,
                  children: e.jsx(se, { className: "h-3.5 w-3.5" }),
                }),
              ],
            }),
          ],
