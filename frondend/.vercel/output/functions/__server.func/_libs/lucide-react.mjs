...
const Droplets = createLucideIcon("droplets", __iconNode$v);
const __iconNode$u = [
...
const PanelLeft = createLucideIcon("panel-left", __iconNode$i);
const __iconNode$h = [
  [
    "path",
    {
...
const Store = createLucideIcon("store", __iconNode$6);
const __iconNode$5 = [
...
const Tent = createLucideIcon("tent", __iconNode$5);
const __iconNode$4 = [
