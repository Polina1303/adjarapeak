...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Dxyd47Pr.mjs");
...
const manifest = {
  "09557be2876269fcfcae243def27d89ac515f3f458d307f436550d081ee75514": {
    functionName: "listAllShopCategories_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  },
  "0cb960d6346718d16b4d10f0b1bf2d013e6f3d2a266d4cf073e82291b5c65b38": {
    functionName: "translateTexts_createServerFn_handler",
    importer: () => import("./translate.functions-CI4CqvQk.mjs")
  },
  "179f7261fd5d340576725bf7fc600d8d9cd7172237163fb37319256e13a185ba": {
    functionName: "listProductsBySlugs_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  },
  "1f1965490baf0720c23fa259555c4316b901461f0e86210badc140904b46816c": {
    functionName: "listShopGroups_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  },
  "219cf6453070a4612f6bd3bb65f56d0e431e02449a65874bc12e6075babda955": {
    functionName: "getShopCategoryView_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  },
  "32c11ab75568a96effb27374cba2290d897b7d8d9d57e1fd431ce70bc724dbdd": {
    functionName: "getShopGroupWithCategories_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  },
  "480fc608907a994787a62a090c70785f42aef9c60ba8fddf663564157772da47": {
    functionName: "listRelatedProducts_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  },
  "6cabca30f37e344192c80bd77f7a568b090d19069ff21d136d8322e66fa0a509": {
    functionName: "listLatestProducts_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  },
  "890babc5afd5ebea25aad54ab275cde853ce1d6b359e7b51386cbc96e9224640": {
    functionName: "getRentalCategoryBySlugWithSub_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  },
  "8b6a42ddf76d53c4d934b3066fdadf1bb2ff7b3704698e8c8a48a1c6fc1229a5": {
    functionName: "getSaleRentals_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  },
  "a4ae9132d3043d5d8e5d3f607bf4736bfc6b1e629ea5e242a9e1d7ecb6d0897f": {
    functionName: "getRentalCategoryView_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  },
  "a4d97f94c786fd86b1040b7178566cd6aaf3e3eb204424db1134f1e11b9aab22": {
    functionName: "getRentalItemBySlug_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  },
  "ab5b27bf6456cfc4c5ae49321245220e31b8167fa1a430c94adf2b366a0b7492": {
    functionName: "getRentalCategoryBySlug_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  },
  "ad0767bd552d4402da48051fa3f60c7d1a6970f734dc19e69f4a597cae791021": {
    functionName: "getSaleProducts_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  },
  "b519af0bd4afa00bcc3dbd753733a69d4be4e44408e0b0ae1e152b191ba5ab9b": {
    functionName: "listAllRentalCategories_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  },
  "b73861788fbe3e2d6a9adc3a091c35b347c3bc6229ce38672c13b77c82ca54e0": {
    functionName: "getRentalGroupView_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  },
  "b7db1b2098419cb7dbcc797222afcc16999a3013de0b96d8b2bfe94f7f2c1c53": {
    functionName: "getShopCategoryBySlug_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  },
  "bf3b3228beaf0b5fc017ad1357cdc9a2bf90689b0609e6f851ec8e13ed6e58a4": {
    functionName: "getShopProductBySlug_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  },
  "c80f203faa6984a0990a2f5e32e49bfc5eba9cbd097a69a103920a1bfb20ef9c": {
    functionName: "searchShopProducts_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  },
  "c918c9ea880298972393527d1055e7baff8da0aea170e6442d014f79a41c4611": {
    functionName: "getShopGroupView_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  },
  "cabc48c43ec23a0866d3aebf4246b636d0e91c2331d1eda11be683e6c8b36e13": {
    functionName: "searchRentalItems_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  },
  "de45ef92726d4f286cdc6352c62af7c5bb7a66adce4de7a43cb7de9e3be782fc": {
    functionName: "listOneProductPerCategorySlug_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  },
  "dea915146ace9a9e89cf3aba49cbd112884b87224a21da7dcf875880edbc4e2f": {
    functionName: "getRentalGroupWithCategories_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  },
  "e4fc291f55a2c79d5aa2ddc2dd57c60c190aeac198f8f662aaa5d2dfdc143b2b": {
    functionName: "getCatalogNav_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  },
  "e75a6741ef669d4164790034db785d5e32a41ffe6499fbea92817801f26e3478": {
    functionName: "listRentalGroups_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  },
  "efc1fdde15af8371f49afe188e2d1b4cae89674c9a74cbe8bb558c51b5ed7efa": {
    functionName: "getCartLineItems_createServerFn_handler",
    importer: () => import("./catalog.functions-B7F3ZRGH.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-iK0vV985.mjs").then((n) => n.z),
