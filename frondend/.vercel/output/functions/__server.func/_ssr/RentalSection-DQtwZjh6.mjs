...
function RentalSection({ groups }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "section-padding py-12 md:py-16 bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl md:text-4xl font-bold text-foreground mb-8 md:mb-10", children: text.rentalEquipment }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3 md:hidden", children: tiles.map((tile, i) => {
      const inner = /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full aspect-square rounded-xl overflow-hidden bg-secondary/60 mb-3 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground text-sm leading-tight group-hover:text-ember transition-colors text-center", children: tile.title })
      ] });
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: tile.kind === "group" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: "/rent",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Carousel, { opts: { align: "start", slidesToScroll: "auto" }, className: "w-full hidden md:block", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CarouselContent, { className: "-ml-3 md:-ml-5", children: tiles.map((tile, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        CarouselItem,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              viewport: { once: true },
              transition: { delay: Math.min(i * 0.04, 0.3) },
              children: tile.kind === "group" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Link,
                {
                  to: "/rent",
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground text-sm md:text-base group-hover:text-ember transition-colors", children: tile.title })
                  ]
                }
