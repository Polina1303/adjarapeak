    ...
    return orderSuccess ? (
      <div className={styles.successWrapper}>
        ...
        <p>
          ...
          <br />
          • По Батуми — 10 лари, бесплатно от 300
          <br />
          • По Грузии — от 20 лари, бесплатно от 500
          <br />❗ Не распространяется на аренду
        </p>

        <p>
          <strong>Самовывоз:</strong>
          <br />
          <MdLocationPin size={20} color="#de682d" />
          <a
        ...
        <p>
          ...
          предоставляется <strong>скидка 5%</strong> на прокат.
        </p>

        <p className={styles.cashback}>
          Если вы отметите нас в соцсетях, мы добавим ещё{" "}
          <strong>5% кэшбэка</strong>
          от суммы заказа. Покажите подписку на своём телефоне при выдаче
          снаряжения. Кэшбэк возвращается, если у вас открытый аккаунт и отметка
          кликабельна.
        </p>
      </div>
    ) : (
