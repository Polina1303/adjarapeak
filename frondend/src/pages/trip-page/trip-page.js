...
const events = [
  ...
  {
    date: "10 августа (вс)",
    title: "ГОМИСМТА - ЧИНЧАО",
    description:
      "Чинчао - озеро кратерного происхождения, расположено в Гурии на высоте 2500 метров над уровнем моря. Гомис мта - летний, высокогорный курорт, высота в разных местах колеблется от 2100 метров, курорт отличается природно-климатическими условиями с лечебными свойствами. 😍С нами у вас есть выбор — отправиться в новый, яркий  хайк или остаться на смотровой ГомисМта, и просто любоваться видами, отдыхая от суеты!",
    price: "100",
    image: gomismta,
    link: "/",
    type: "group",
