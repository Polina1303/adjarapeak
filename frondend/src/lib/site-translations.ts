...
export const SITE_TEXT = {
  RU: {
    ...
    service: {
      ...
      bookingDescription:
        "Оставьте контакты и кратко опишите, что нужно отремонтировать. Мы свяжемся с вами для уточнения деталей.",
      bookingServiceLabel: "Направление сервиса",
      ...
      bookingPhonePlaceholder: "+995 …",
      bookingTelegramLabel: "Telegram",
      bookingTelegramPlaceholder: "@username — необязательно",
      bookingCommentLabel: "Что нужно отремонтировать?",
      bookingCommentPlaceholder:
        "Например: настроить тормоза, заменить колёса или устранить прокол SUP-доски",
      bookingSubmit: "Отправить заявку",
      bookingSubmitting: "Отправка…",
      bookingSent: "Заявка отправлена — скоро свяжемся с вами",
      bookingNameError: "Укажите имя",
      bookingPhoneError: "Укажите номер телефона",
      bookingSendError: "Не удалось отправить заявку",
      bookingCloseLabel: "Закрыть форму записи",
      ...
      priceColumn: "Цена",
      summerGearEyebrow: "Дополнительный сервис",
      summerGearTitle: "Ремонт летнего снаряжения",
      servicePriceLabel: "Стоимость работы",
      skateServiceTitle: "Сервис роликовых коньков и скейтбордов",
      skateServiceDescription:
        "Замена расходников: подшипников, бушингов и колёс.",
      skateServicePrice: "20 ₾",
      skateServiceNote: "Комплектующие не входят в стоимость.",
      supServiceTitle: "Ремонт SUP-досок",
      supServiceDescription:
        "Устранение проколов, порезов и повреждений швов.",
      supServicePrice: "от 100 ₾",
      supServiceControl:
        "После ремонта в течение суток самостоятельно контролируем давление и проверяем герметичность. Все работы проводим в сухом помещении.",
      supServiceWarranty: "Гарантия на ремонт",
  ...
  EN: {
    ...
    service: {
      ...
      bookingDescription:
        "Leave your contact details and briefly describe what needs repairing. We will contact you to confirm the details.",
      bookingServiceLabel: "Service category",
      ...
      bookingPhonePlaceholder: "+995 …",
      bookingTelegramLabel: "Telegram",
      bookingTelegramPlaceholder: "@username — optional",
      bookingCommentLabel: "What needs repairing?",
      bookingCommentPlaceholder:
        "For example: tune the brakes, replace wheels or repair a SUP board puncture",
      bookingSubmit: "Send request",
      bookingSubmitting: "Sending…",
      bookingSent: "Request sent — we will contact you soon",
      bookingNameError: "Enter your name",
      bookingPhoneError: "Enter your phone number",
      bookingSendError: "Could not send the request",
      bookingCloseLabel: "Close booking form",
      ...
      priceColumn: "Price",
      summerGearEyebrow: "Additional services",
      summerGearTitle: "Summer gear repairs",
      servicePriceLabel: "Service price",
      skateServiceTitle: "Roller skate and skateboard service",
      skateServiceDescription:
        "Replacement of wear parts: bearings, bushings and wheels.",
      skateServicePrice: "20 ₾",
      skateServiceNote: "Replacement parts are not included in the price.",
      supServiceTitle: "SUP board repair",
      supServiceDescription:
        "Repair of punctures, cuts and damaged seams.",
      supServicePrice: "from 100 ₾",
      supServiceControl:
        "After the repair, we monitor the pressure and test for leaks for 24 hours. All work is carried out in a dry indoor space.",
      supServiceWarranty: "Repair warranty",
  ...
  GE: {
    ...
    service: {
      ...
      bookingDescription:
        "დატოვეთ საკონტაქტო ინფორმაცია და მოკლედ აღწერეთ, რა არის შესაკეთებელი. დეტალების დასაზუსტებლად დაგიკავშირდებით.",
      bookingServiceLabel: "სერვისის მიმართულება",
      ...
      bookingPhonePlaceholder: "+995 …",
      bookingTelegramLabel: "Telegram",
      bookingTelegramPlaceholder: "@username — სურვილისამებრ",
      bookingCommentLabel: "რა არის შესაკეთებელი?",
      bookingCommentPlaceholder:
        "მაგალითად: მუხრუჭების რეგულირება, ბორბლების შეცვლა ან SUP დაფის პუნქციის შეკეთება",
      bookingSubmit: "განაცხადის გაგზავნა",
      bookingSubmitting: "იგზავნება…",
      bookingSent: "განაცხადი გაიგზავნა — მალე დაგიკავშირდებით",
      bookingNameError: "მიუთითეთ სახელი",
      bookingPhoneError: "მიუთითეთ ტელეფონის ნომერი",
      bookingSendError: "განაცხადის გაგზავნა ვერ მოხერხდა",
      bookingCloseLabel: "ჩაწერის ფორმის დახურვა",
      ...
      priceColumn: "ფასი",
      summerGearEyebrow: "დამატებითი სერვისი",
      summerGearTitle: "ზაფხულის აღჭურვილობის შეკეთება",
      servicePriceLabel: "სამუშაოს ღირებულება",
      skateServiceTitle: "როლიკებისა და სკეიტბორდების სერვისი",
      skateServiceDescription:
        "ცვეთადი ნაწილების შეცვლა: საკისრები, ბუშინგები და ბორბლები.",
      skateServicePrice: "20 ₾",
      skateServiceNote: "კომპონენტები ფასში არ შედის.",
      supServiceTitle: "SUP დაფების შეკეთება",
      supServiceDescription:
        "პუნქციების, ჭრილობებისა და დაზიანებული ნაკერების შეკეთება.",
      supServicePrice: "100 ₾-დან",
      supServiceControl:
        "შეკეთების შემდეგ 24 საათის განმავლობაში თავად ვაკონტროლებთ წნევას და ჰერმეტულობას. ყველა სამუშაო მშრალ სივრცეში სრულდება.",
      supServiceWarranty: "გარანტია შეკეთებაზე",
