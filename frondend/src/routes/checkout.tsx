...
const CHECKOUT_TEXT: Record<Lang, CheckoutText> = {
  RU: {
    ...
    note: "*Укажите, пожалуйста: самовывоз или доставка, адрес доставки и желаемую дату. После оформления заказа с вами свяжутся. Важно: для арендных товаров доступен только самовывоз.",
    submitting: "Отправка…",
