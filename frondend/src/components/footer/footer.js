      ...
      <div className="footer-container">
        <ul className="footer-container-list">
          ...
          <li>
            ...
            >
         {languages==="RU"? 'Батуми ул.Тбел-Абусеридзе, 38. понедельник-суббота (11:00-19:00)':"Batumi, 38 Tbel-Abuseridze Street. Monday-Saturday (11:00-19:00)"}   
            </a>
          </li>
          <li>
